# phaseField
The phasefield repository includes 2 main parts the phasefield simulations and the computational homogenization simulations using nastran scripts.
The phasefield simulations are based on the pystencils library and the tutorials for spinodal decomposition by Martin Bauer, Markus Holzer, Frederik Hennig, https://pycodegen.pages.i10git.cs.fau.de/pystencils/notebooks/05_tutorial_phasefield_spinodal_decomposition.html
...
In total 1000 micro objects are made to get a dataset for different homogenized parameteres from phase parameters. 
